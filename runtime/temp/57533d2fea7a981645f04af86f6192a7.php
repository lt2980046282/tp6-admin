<?php /*a:1:{s:49:"D:\web-template\tp\tp\view\admin\member-list.html";i:1615964709;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','static/member-add.html',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
